  ...
  etapes: [
    ...
    },
    {
      ...
      application: {
        ...
        en: "Our dashboard cards now display the real country name and its flag, fetched live from the API. In the next module, we will add temperature and weather conditions — and learn how to handle loading states and network errors."
      },
      quiz: [
        {
          type: "complete",
